...
def demographic_data(df, db, context):
    ...
    if context['country'] == 'nz':
        ...
        sorted_demo = sorted_demo.rename({'population':'total', 'pop_euro':'white', 'pop_maori':'maori', 'pop_asian':'asian', 'pop_pacific':'polynesian', 'pop_melaa':'melaa'}, axis=1)
        demo = sorted_demo[['total', 'white', 'maori', 'asian', 'polynesian', 'melaa']]
        ...
        relevant_demo = relevant_demo.rename({'H7X001':'total', 'H7X002':'white', 'H7X003':'african_american', 'H7X004':'american_indian_or_alaska', 'H7X005':'asian', 'H7X006':'native_hawaiian_or_pi', 'H7Y003':'latino'}, axis=1)
        demo = relevant_demo[['total', 'white', 'american_indian_or_alaska', 'asian', 'native_hawaiian_or_pi', 'latino', 'african_american']]
