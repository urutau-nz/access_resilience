...
file_path = r'/homedirs/man112/monte_christchurch/results/recovery/random_recovery_{}_{}.csv'.format(optimise_service, optimise_demographic)
...
def get_damages(state, hazard_type, optimise_service):
    ...
    roads_options = gpd.read_file(r'/homedirs/man112/monte_christchurch/results/recovery/road_options.shp')
    # get services used in greedy optimise run
    df_dests = gpd.read_file(r'/homedirs/man112/monte_christchurch/results/recovery/service_options.shp')
