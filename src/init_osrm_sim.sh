...
#rm -f $1-latest*
#wget -N http://download.geofabrik.de/australia-oceania/$1-latest.osm.pbf
...
docker run -t -v $4:/data osrm/osrm-backend osrm-customize /data/$1-latest.osrm --segment-speed-file /data/updates/update.csv
