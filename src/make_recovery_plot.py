...
axes[0].plot(time, iso_data, label='Data-driven recovery')
axes[0].plot(time, iso_random, label='Randomised recovery')
axes[0].plot(time, iso_between, label='Informed recovery')
axes[0].invert_yaxis()
axes[0].set_ylabel('ISO')
axes[0].grid(axis='x')


axes[1].plot(time, ede_data,label='Data-driven recovery')
axes[1].plot(time, ede_random, label='Randomised recovery')
axes[1].plot(time, ede_between, label='Informed recovery')
axes[1].invert_yaxis()
axes[1].set_ylabel('EDE')
axes[1].grid(axis='x')
...
plt.legend()
plt.xlabel('time')
plt.savefig(r'/home/mitchell/projects/access_resilience/results/new_recovery_curve')
