...
def main():
    recovery_info = pd.read_csv(r'results/recovery/recovery_supermarket_total_pop.csv')
    services_out = gpd.read_file(r'results/recovery/service_options.shp')
    roads_out = gpd.read_file(r'results/recovery/road_options.shp')
    # set up results
    ...
    gdf.to_file(r'results/recovery/recovery_distances.shp')
